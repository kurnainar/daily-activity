<div class="modal fade" id="clienttype-add">
	<div class="modal-dialog modal-lg" style="width:30%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="frmClientTypeAdd">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label for="cltpadd-nama">Nama Tipe Klien:</label>
										<input type="text" class="form-control" id="cltpadd-nama" name="cltpadd-nama" autofocus>
									</div>
								</div>
							</div>
						</form>
			...
			<div class="modal-footer">
				<div id="progress">
					<button type="button" class="btn btn-success" id="btn-simpan-cltp"><i class="fa fa-save"></i> Simpan </button>
